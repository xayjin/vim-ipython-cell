...
command! -nargs=0 IPythonCellExecuteCellJump call IPythonCellExecuteCell('False', 1)
command! -nargs=0 IPythonCellExecuteCellVerbose call IPythonCellExecuteCell('True')
command! -nargs=0 IPythonCellExecuteCellVerboseJump call IPythonCellExecuteCell('True', 1)
